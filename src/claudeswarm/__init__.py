...
This package provides a multi-terminal coordination system that enables multiple
Claude Code agents to work together on shared projects through:
- Agent discovery and registry management
- Inter-agent messaging (tmux send-keys or file-based)
...
- TmuxBackend: Full tmux integration (send-keys, pane management)
